      ...
      variants: [
        {
          id: 'ch4-q15-v2',
          title: '人生的意義',
          narrative: `深夜睡不著，你翻開了很久沒看的日記本。裡面記錄著來到新語市後的點點滴滴。

你開始思考：什麼樣的人生才是有意義的？成就、影響力、關係，還是個人成長？
...
每個人的答案或許不同——`,
        ...
        },
        {
          id: 'ch4-q15-v3',
          title: '理想的生活',
          narrative: `朋友問你一個問題：「如果錢不是問題，你想過什麼樣的生活？」

這個問題讓你陷入思考。拋開現實的限制，你心中理想的生活是什麼樣子？`,
          choiceTexts: [
            '創立自己的事業，追求更大的夢想',
            '分享自己的故事，激勵更多的人',
            '和喜歡的人在一起，過平靜充實的生活',
      ...
      variants: [
        {
          id: 'ch4-q16-v2',
          title: '給自己的信',
          narrative: `你打開手機的備忘錄，開始寫一封給六個月前的自己的信。

那時候的你剛到這座城市，充滿不安和期待。現在的你會給他什麼建議？`,
          choiceTexts: [
            '「不要害怕失敗，每次跌倒都是成長的機會」',
            '「相信自己的才華，勇敢展現你是誰」',
            '「用心經營關係，好的朋友會陪你走很遠」',
        ...
        },
        {
          id: 'ch4-q16-v3',
          title: '給後輩的建議',
          narrative: `一位剛來這座城市的新人聯繫你，想向你請教在這裡生活和工作的心得。

回想自己的經歷，你決定告訴他最重要的一件事——`,
          choiceTexts: [
            '「抓住每個機會，主動爭取你想要的」',
            '「做你自己，世界會欣賞真實的你」',
            '「人脈很重要，善待你遇到的每個人」',
